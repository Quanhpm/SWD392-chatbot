...
const documentScope = (document: IDocument): string => document.visibility === 'class-restricted'
  ? `Chỉ lớp: ${(document.classIds ?? []).map((value) => typeof value === 'string' ? value : `${value.code} · ${value.name}`).join(', ') || 'chưa xác định'}`
  : 'Dùng chung toàn môn';
...
.admin-page{width:100%;padding:28px;max-width:1480px;margin:auto}.admin-hero{padding:0 0 22px;border-bottom:1px solid var(--color-outline-variant);display:flex;justify-content:space-between;align-items:flex-end}.admin-hero span{font-size:11px;font-weight:700;letter-spacing:.08em;color:var(--color-primary)}.admin-hero h1{font-size:28px;letter-spacing:-.03em;margin:4px 0}.admin-hero p{color:var(--color-on-surface-variant)}.admin-hero button,.admin-tabs button,.admin-card button{min-height:36px;background:#fff;border:1px solid var(--color-outline-variant);padding:8px 12px;border-radius:8px;color:#334155;font-size:13px;font-weight:600}.admin-hero button:hover,.admin-card button:hover{background:#f8fafc;border-color:#cbd5e1}.admin-card .btn-primary{background:var(--color-primary);color:#fff;border-color:var(--color-primary)}.admin-tabs{display:flex;gap:4px;margin:18px 0;padding:4px;width:max-content;max-width:100%;overflow:auto;border:1px solid var(--color-outline-variant);border-radius:10px;background:#fff}.admin-tabs button{border:0;background:transparent;white-space:nowrap}.admin-tabs button.active{background:#f1f5f9;color:#0f172a}.admin-tabs.compact{margin:0;border:0;padding:0}.admin-message{margin:14px 0;padding:10px 13px;background:#f0fdf4;color:#166534;border:1px solid #dcfce7;border-radius:8px;display:flex;justify-content:space-between}.metric-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.metric-card,.admin-card{background:#fff;border:1px solid var(--color-outline-variant);border-radius:12px;padding:18px;box-shadow:var(--shadow-sm)}.metric-card strong{display:block;font-size:28px;letter-spacing:-.03em;color:#0f172a}.metric-card span,.admin-card small{display:block;color:var(--color-on-surface-variant);margin-top:4px}.admin-grid{display:grid;gap:14px}.admin-grid.two{grid-template-columns:300px 1fr}.admin-grid.three{grid-template-columns:repeat(3,1fr)}.admin-grid.review-grid{grid-template-columns:340px 1fr}.form-stack{display:flex;flex-direction:column;gap:10px}.admin-card h2{font-size:17px;margin-bottom:14px}.admin-card input,.admin-card select,.admin-card textarea{border:1px solid var(--color-outline-variant);background:#fff;padding:9px 11px;border-radius:8px;width:100%}.admin-card input:focus,.admin-card select:focus,.admin-card textarea:focus{border-color:var(--color-primary);box-shadow:0 0 0 3px rgb(37 99 235/.1)}.admin-card textarea{min-height:80px}.check{display:flex;align-items:center;gap:8px}.check input{width:auto}.admin-toolbar,.section-title,.list-row,.actions{display:flex;align-items:center;gap:8px}.admin-toolbar,.section-title,.list-row{justify-content:space-between}.table-wrap{overflow:auto;margin-top:12px}.actions{justify-content:flex-end}.stack-list{display:flex;flex-direction:column;gap:7px}.list-row,.review-row{padding:10px;border:1px solid #e2e8f0;border-radius:8px}.class-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.class-card{border:1px solid #e2e8f0;border-radius:10px;padding:15px;display:flex;flex-direction:column;gap:11px}.class-card code{font-size:18px;letter-spacing:2px;background:#f8fafc;border:1px solid #e2e8f0;padding:9px;border-radius:7px;text-align:center}.status{font-size:10px;font-weight:700;text-transform:uppercase;padding:3px 7px;border-radius:20px;background:#f1f5f9;color:#475569}.status.active{background:#f0fdf4;color:#166534}.review-row{text-align:left;background:#fff}.review-row:hover{background:#f8fafc}.review-row.selected{border-color:#93c5fd;background:#eff6ff}.preview-card iframe{width:100%;height:440px;border:1px solid #e2e8f0;border-radius:8px;margin:14px 0}.preview-card h3{margin-top:16px}.text-preview{max-height:260px;overflow:auto;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:14px;white-space:pre-wrap}.text-preview p+p{margin-top:10px}.assist-preview{display:grid;grid-template-columns:repeat(2,1fr);gap:8px;margin:10px 0}.assist-preview div{background:#f8fafc;border:1px solid #eef2f7;padding:10px;border-radius:8px}.admin-card .approve{background:#15803d;color:#fff;border-color:#15803d}.admin-card .reject{background:#dc2626;color:#fff;border-color:#dc2626}.download-link{display:block;padding:16px;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;margin:14px 0;text-align:center}.empty{min-height:400px;display:grid;place-items:center;color:#64748b}@media(max-width:1000px){.metric-grid,.admin-grid.two,.admin-grid.three,.admin-grid.review-grid,.class-grid{grid-template-columns:1fr}.admin-page{padding:18px}.admin-hero{align-items:flex-start;gap:16px}.admin-tabs{width:100%}}@media(max-width:640px){.admin-hero{flex-direction:column}.metric-grid{grid-template-columns:1fr 1fr}}
`}</style>;
