...
export const DocumentsPage: React.FC = () => {
  ...
  return <div className="documents-page-container"><div className="page-header"><div><span>{isTeacher ? 'TEACHER LIBRARY' : 'STUDENT LIBRARY'}</span><h1>Tài liệu môn học</h1><p>{isTeacher ? 'Theo dõi phạm vi lớp, trạng thái xử lý và kết quả duyệt của admin.' : 'Chỉ tài liệu đã duyệt và đúng phạm vi lớp của bạn mới xuất hiện.'}</p></div></div>
